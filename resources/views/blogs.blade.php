...
@section('homepage-contain')
    ...
    <div class="row">
        <div class="col-md-3">
            <div _ngcontent-c3="" class="blog-listingfilter">
        ...
        <div class="col-md-9">
            <div _ngcontent-c3="" class="rightside-panel" style="">
                <div _ngcontent-c3="" class="listing-col-one">
                    <div _ngcontent-c3="" class="row">
                        ...
                        <div _ngcontent-c3="" class="col-md-12 col-xl-4">
                            <div _ngcontent-c3="" class="blog-listing-detail"><span _ngcontent-c3=""
                                    class="category">Offshore Development</span><a _ngcontent-c3=""
                                    href="/blog/offshore-outsourcing/what-makes-indianic-the-best-place-to-hire-ios-developers.html">What
                                    makes IndiaNIC the Best Place to Hire iOS Developers?</a>
                                <p _ngcontent-c3="">
                                <p>The hiring model is also popularly known as an engagement with an offshore or onshore
                                    development company to hire dedicated developers to extend a project team. It is all
                                    about…
                                </p>
                                </p>
                            </div>
                ...
                <div +-c3="" class="listing-view">
                    <div _ngcontent-c3="" class="row">
                        @foreach ($articles as $articles1)
                            <div _ngcontent-c3="" class="col-md-6 col-lg-6 col-xl-4 mar-top-30">
                                <div _ngcontent-c3="" class="listing-sm-img">
                                    <a _ngcontent-c3="" href="/single-blogs/{{ $articles1->id }}">
                                        <img src="{{ asset('backend/images/articles/' . $articles1->banner_image) }}"
                                            alt="" class="ng-lazyloaded">
                                    </a>
                                </div>
                                <div _ngcontent-c3="" class="blog-listing-detail"><span _ngcontent-c3=""
                                        class="category">
                                        @php
                                            $id = json_decode($articles1->category);
                                            $article_category_data = App\Models\Article_category::whereIN('id', json_decode($articles1->category, true))->get();
                                        @endphp
                                        @foreach ($article_category_data as $v)
                                            {{ $v->category }} ,
                                        @endforeach
                                    </span>
                                    <a _ngcontent-c3=""
                                        href="{{ url('/article/' . $articles1->id) }}">{{ $articles1->title }}</a>
                                </div>
                            </div>
                        @endforeach
                    </div>
                ...
                <div _ngcontent-c3="" class="listing-pagination blog-pagination">
                    <bja-pagination _ngcontent-c3="" _nghost-c4="">
                        <div _ngcontent-c4="" class="bja-pagination">
                            <button _ngcontent-c4="" class="nav-page active"> 1 </button><button _ngcontent-c4=""
                                class="nav-page"> 2 </button><button _ngcontent-c4="" class="nav-page"> 3
                            </button>
                            <span _ngcontent-c4="" class="bullet">...</span><button _ngcontent-c4=""
                                class="nav-last"> 91 </button>
                            <button _ngcontent-c4="" class="nav-right"> &gt; </button>
                        </div>
                    </bja-pagination>
                </div>
            </div>

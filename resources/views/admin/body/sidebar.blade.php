...
<section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="{{ $route == 'articles_tag.index' ? 'active' : '' }}">
           <a href="{{ route('articles_tag.index') }}">
               <i data-feather="box"></i>
               <span>Article Tag</span>
           </a>
       </li>

       <li class="{{ $route == 'articles_category.index' ? 'active' : '' }}">
           <a href="{{ route('articles_category.index') }}">
               <i data-feather="box"></i>
               <span>Article Category</span>
           </a>
       </li>

       <li class="{{ $route == 'articles.index' ? 'active' : '' }}">
        ...
        <li class="treeview {{ $prefix == '/marks' ? 'active' : '' }}">
            ...
            <ul class="treeview-menu">
                ...
                <li class="{{ $route == 'marks.entry.edit' ? 'active' : '' }}"><a href="#"><i
                            class="ti-more"></i>Marks Edit</a></li>

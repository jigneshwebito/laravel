...
@section('mobile-contain')
    ...
    $slide6title = 'Hudson Testing Consultation ';
    $slide6desc = 'Hire Hudson consultants who provide innovative automated testing services to quickly identify and resolve issues.';
    ?>

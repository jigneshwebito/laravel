        ...
        <div class="container-full">
            <section class="content">
                ...
                <span class="profile_image_preview_span">
                    <img class="profile_front_image_preview" src="" style="height: 7rem;" />
                </span><br>
                ...
                {{-- <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <!-- Submit button -->
                        <button type="submit" class="btn btn-primary mb-4">Add Article Tag</button>
                    </div> --}}


                {{-- <label for="">Client name</label>
                <input type="text" class="form-control mb-2" id="" placeholder="Name"> --}}

...
<div class="content-wrapper">
    <div class="container-full">
        <section class="content">
            ...
            <form action="/articles_category" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-6">
                        <label class="form-label" for="form4Example2">Parent Category</label>
                        <div class="form-outline mb-4">
                            <select class="form-control input-md" name="sub_category">

...
@section('admin')
    ...
    <div class="content-wrapper">
        <div class="container-full">
            <section class="content">
                ...
                <div class="form-outline mb-4">
                    <input type="text" name="year" id="year" value="{{ $tm->year }}" class="form-control" required />
                </div>
                <label class="form-label" for="form4Example2">Review</label>
                <div class="form-outline mb-4">
                    <textarea type="text" name="review" id="review" class="form-control" required>{{ $tm->review }}</textarea>
                </div>
    ...
    <script>
        function pageRedirectProfileUpdate() {
            ...
            $.ajax({
                type: 'POST',
                url: ' {{ route('work_slider_update_data') }}',
                data: {
                    _token: '{{ csrf_token() }}',

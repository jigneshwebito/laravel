...
<div class="content-wrapper">
    <div class="container-full">
        ...
        <form action="/articles_subCategory/{{ $article_subCategory->id }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-outline mb-4">
                            <input type="text" name="name" id="form4Example2" class="form-control" value="{{ $article_subCategory->name }}" required />

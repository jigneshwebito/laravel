!(function() {
    ...
    var i,
                ...
                function(t, o, c) {
                    ...
                    if (!b) {
                        if (!(w = "auto" === e.grid ? 0 : (e.grid || [1, I])[1])) {
                            for (
                                v = -1e8; v < (v = c[w++].getBoundingClientRect().left) &&
                                w < x;
        ...
        de = function(t) {
            for (
                var e, r, i, n, s = 0, o = ""; ~(e = t.indexOf("random(", s));
        ...
        be = function(t, e, r) {
            ...
            return (
                ...
                ((i = d[0] / ye),
                    ...
                    (s = d[2] / ye),
                    (u =
                        ((h = Math.max(i, n, s)) + (l = Math.min(i, n, s))) /
                        2),
                    h === l ?
                    (o = a = 0) :
                    ((c = h - l),
        ...
        Te = function(t, e, r) {
            ...
            if (
                ...
                for (
                    o = (n = t.replace(Me, "1").split(K)).length - 1; l < o; l++
                )
                    a +=
                    n[l] +
                    (~i.indexOf(l) ?
            ...
            if (!n)
                for (o = (n = t.split(Me)).length - 1; l < o; l++)
                    a += n[l] + u[l];
            return a + n[o];
        },
        Me = (function() {
        ...
        ((v = Date.now),
            ...
            (m = {
                    ...
                    u &&
                        (!o &&
                            ...
                            ((s = o = window),
                                ...
                                ot(
                                    st || s.GreenSockGlobals || (!s.gsap && s) || {}
                                ),
                ...
                sleep: function() {
                    (p ? s.cancelAnimationFrame : clearTimeout)(f),
                    (c = 0),
                    (d = lt);
                },
            ...
            return (
                ...
                (e.totalTime = function(t, e) {
                    ...
                    if (r && r.smoothChildTiming && this._ts) {
                        for (
                            Ut(this, t), !r._dp || r.parent || Wt(r, this); r.parent;
                ...
                (e.globalTime = function(t) {
                    for (
                        var e = this, r = arguments.length ? t : e.rawTime(); e;
    ...
    var Xe = (function(t) {
        ...
        return (
            ...
            (s.render = function(t, e, r) {
                ...
                if (y !== this._tTime || r || w) {
                        ...
                        if (
                            ((i = Ot(y % u)),
                                ...
                                ((a = ~~(y / u)) &&
                                    ...
                                    ((i = v), a--),
                                    i > v && (i = v)),
                                (d = Vt(this._tTime, u)), !_ && this._tTime && d !== a && (d = a),
                                p && 1 & a && ((i = v - i), (m = 1)),
                                a !== d && !this._lock)
                        ) {
                            var x = p && 1 & d,
                            ...
                            if (
                                (a < d && (x = !x),
                                    ...
                                    (this.render(
                                        _ || (m ? 0 : Ot(a * u)),
                                        e, !v
                                    )._lock = 0), !e && this.parent && _e(this, "onRepeat"),
                    ...
                    if (
                        ...
                        return (
                            (this._start = f), Yt(this), this.render(t, e, r)
                        );
            ...
            (s.previousLabel = function(t) {
                return (
                    void 0 === t && (t = this._time), me(this, te(this, t), 1)
                );
            }),
            ...
            (s.totalDuration = function(t) {
                ...
                if (o._dirty) {
                    for (i = o.parent; a;)
                        ...
                        (a = e);
                    Zt(o, o === n && o._time > s ? o._time : s, 1, 1),
                        (o._dirty = 0);
                }
                return o._tDur;
            }),
            (i.updateRoot = function(t) {
                if (
                    (n._ts && (St(n, Xt(t, n)), (h = ke.frame)), ke.frame >= _t)
                ) {
                    _t += C.autoSleep || 120;
                    var e = n._first;
                    if (
    ...
    var Ye,
        ...
        He = function(t, e, r, i, n, s) {
            ...
            if (
                ...
                ((r._pt = a =
                        new fr(r._pt, n, t, 0, 1, o.render, o, 0, o.priority)),
                    r !== l)
            )
                for (
                    u = r._ptLookup[r._targets.indexOf(n)], h = o._props.length; h--;
        ...
        Qe = function t(e, r) {
            ...
            if (
                (q && (!k || !y) && (y = "none"),
                    ...
                    e._yoyo &&
                    !e._repeat &&
                    ((S = e._yEase), (e._yEase = e._ease), (e._ease = S)), !q)
            ) {
                if (
                ...
                for (
                    e._pt = 0, b = (A && W(b)) || (b && !A), o = 0; o < I.length; o++
                ) {
                    if (
        ...
        Je = (function(t) {
            function s(r, s, o, a) {
                ...
                if (
                    ((u._targets = k.length ?
                            ...
                            ut(
                                "GSAP target " +
                                r +
                                " not found. https://greensock.com", !C.nullTargetWarn
                            ) || []),
                        (u._ptLookup = []),
                        (u._overwrite = b),
                        O || x || Q(v) || Q(y))
                ...
                return (!0 !== b || i || ((Ye = e(u)), n.killTweensOf(k), (Ye = 0)),
                    S && Wt(S, e(u)),
                    (w ||
                        (!v &&
                            !O &&
                        ...
                        if (
                            ...
                            if (((i = m), (l = this.timeline), this._repeat)) {
                                ...
                                if (
                                    ...
                                    return this;
                                s !== a &&
                                    (l && this._yEase && Re(l, u), !this.vars.repeatRefresh ||
                                        u ||
                                        this._lock ||
                                        ((this._lock = r = 1),
                                            (this.render(
    ...
    var gr,
        ...
        Gr = function(t, e, r) {
            ...
            for (
                t = t.charAt(0).toUpperCase() + t.substr(1); n-- && !(Qr[n] + t in i);
        ...
        Kr = function(t) {
            ...
            return (
                (e && (e.width || e.height)) ||
                t.getBBox === Zr ||
                (e = Zr.call(t, !0)), !e || e.width || e.x || e.y ?
                e :
                {
                    x: +Jr(t, ["x", "cx", "x1"]) || 0,
                    y: +Jr(t, ["y", "cy", "y1"]) || 0,
        ...
        _i = function(t, e) {
            ...
            return (
                ...
                ((D = !r.uncache && !e && t.getAttribute("data-svg-origin")),
                    mi(
                        t,
                        D || j, !!D || r.originIsAbsolute, !1 !== r.smooth,
                        _
                    )),
                (p = r.xOrigin || 0),
                (m = r.yOrigin || 0),
                ...
                ((w = _[0]),
                    ...
                    ((D = t.getAttribute("transform")),
                        (r.forceCSS =
                            t.setAttribute("transform", "") || !fi(Hr(t, Yr))),
        ...
        Si = function(t, e, r) {
            ...
            for (n in (l.svg ?
                ...
                0 &&
                ((a =
                        ie(s) !== (h = ie(o)) ? ni(r, n, s, h) : parseFloat(s)),
                    (u = parseFloat(o)),
    ...
    !(function(t, e) {
        ...
        (o.prototype.addElementImages = function(t) {
            ...
            if (e && a[e]) {
                for (
                    var r = t.querySelectorAll("img"), i = 0; i < r.length; i++
                ) {
                    var n = r[i];
                    this.addImage(n);
                }
        ...
        return (
            (o.prototype.addElementBackgroundImages = function(t) {
                ...
                if (e)
                    for (
                        var r = /url\((['"])?(.*?)\1\)/gi,
                            i = r.exec(e.backgroundImage); null !== i;
    ...
    class hn {
        constructor(t) {
            ...
            (this.DOM.image =
                this.DOM.imgWrap.querySelector(".preview__item-img")),
            (this.DOM.title = this.DOM.el.querySelector(
                ".preview__item-title"
            )),
            (this.DOM.titleChars = [
                ...this.DOM.title.querySelectorAll(".char"),
            ]),
    ...
    class fn {
        constructor(t) {
            ...
            (this.DOM.contentEl = document.querySelector(
                this.DOM.el.href.substring(
                    this.DOM.el.href.lastIndexOf("#")
                )
            )),
            ...
            this.hoverTimeout = setTimeout(() => {
                this.timelineHoverOut && this.timelineHoverOut.kill(),
                    (this.timelineHoverIn = Ii.timeline()
                        .addLabel("start", 0)
                        .to(
                            this.DOM.image, { duration: 0.8, ease: "expo", scale: 1.1 },
                            "start"
                        ));
            }, 10);
        }
    ...
    (pn = function() {
        ...
        function o(e, r) {
            return e && 0 != e.length ?
                ...
                [e] :
                [].slice.call(
                    e[0].nodeName ? e : (r || t).querySelectorAll(e)
                ) :
                [];
        }
                ...
                o(t.childNodes).some(function(t) {
                    if (!t.tagName || t.hasChildNodes()) {
                        if (t.childNodes && t.childNodes.length)
                            return (
                                f.push(t),
                                void l.push.apply(l, m(t, r, s, a, h))
                            );
                        var i = t.wholeText || "",
                            o = i.trim();
                        o.length &&
        ...
        var O = f("lines", [_], "line", function(t, e, r) {
            ...
            E = f(k, 0, 0, function(t, e) {
                ...
                if (
                    ((e.image =
                            e.image || s(t, "image") || t.currentSrc || t.src),
                        e.image)
                ) {
                    var h = o("img", t)[0];
    ...
    class gn extends Yi.EventEmitter {
        ...
        hideContent(t) {
            ...
            Ii.timeline({
                    onComplete: () => {
                        t.preview.DOM.el.classList.remove(
                                "preview__item--open"
                            ),
                ...
                .to(
                    t.preview.DOM.image, { duration: 1.5, ease: "expo.inOut", y: "-100%" },
                    "start"
                )
                .to(
                    t.preview.DOM.backCtrl, {
    ...
    const vn = new(class {
        constructor(t) {
            ...
            (this.DOM.circle = this.DOM.svg.querySelector(
                ".cursor__svg-circle"
            )),
    ...
    })(document.querySelector(".cursor-team"));
    var yn;
    ((yn = ".grid__item-img"),
        new Promise((t, e) => {
    ...
    }), [...document.querySelectorAll("a, button, .grid__item")].forEach(
        (t) => {
